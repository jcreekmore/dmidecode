...
impl From<u16> for ProcessorFamily  {
    fn from(word: u16) -> ProcessorFamily {
        match word {
            ...
            n @ 0x102..=0x103   => ProcessorFamily::Available(n),
...
impl fmt::Display for ProcessorFamily {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            ProcessorFamily::PentiumProcessorWithMMXTechnology               => write!(f, "Pentium® processor with MMX™ technology"),
            ...
            ProcessorFamily::IntelPentium4HTProcessor                        => write!(f, "Intel® Pentium® 4 HT processor"),
            ProcessorFamily::AMDDuronProcessorFamily                         => write!(f, "AMD Duron™ Processor Family [1]"),
            ...
            ProcessorFamily::AMDAthlonProcessorFamily                        => write!(f, "AMD Athlon™ Processor Family [1]"),
            ...
            ProcessorFamily::IntelCoreDuoMobileProcessor                     => write!(f, "Intel® Core™ Duo mobile processor"),
            ProcessorFamily::IntelCoreSoloMobileProcessor                    => write!(f, "Intel® Core™ Solo mobile processor"),
            ...
            ProcessorFamily::AMDTurionIIUltraDualCoreMobileMProcessorFamily  => write!(f, "AMD Turion™ II Ultra Dual-Core Mobile M Processor Family"),
            ProcessorFamily::AMDTurionIIDualCoreMobileMProcessorFamily       => write!(f, "AMD Turion™ II Dual-Core Mobile M Processor Family"),
            ProcessorFamily::AMDAthlonIIDualCoreMProcessorFamily             => write!(f, "AMD Athlon™ II Dual-Core M Processor Family"),
            ProcessorFamily::AMDOpteron6100SeriesProcessor                   => write!(f, "AMD Opteron™ 6100 Series Processor"),
            ProcessorFamily::AMDOpteron4100SeriesProcessor                   => write!(f, "AMD Opteron™ 4100 Series Processor"),
            ProcessorFamily::AMDOpteron6200SeriesProcessor                   => write!(f, "AMD Opteron™ 6200 Series Processor"),
            ProcessorFamily::AMDOpteron4200SeriesProcessor                   => write!(f, "AMD Opteron™ 4200 Series Processor"),
            ...
            ProcessorFamily::AMDOpteron4300SeriesProcessor                   => write!(f, "AMD Opteron™ 4300 Series Processor"),
            ProcessorFamily::AMDOpteron6300SeriesProcessor                   => write!(f, "AMD Opteron™ 6300 Series Processor"),
            ProcessorFamily::AMDOpteron3300SeriesProcessor                   => write!(f, "AMD Opteron™ 3300 Series Processor"),
            ProcessorFamily::AMDFireProSeriesProcessor                       => write!(f, "AMD FirePro™ Series Processor"),
            ...
            ProcessorFamily::AMDAthlonX4QuadCoreProcessorFamily              => write!(f, "AMD Athlon(TM) X4 Quad-Core Processor Family"),
            ProcessorFamily::AMDOpteronX1000SeriesProcessor                  => write!(f, "AMD Opteron(TM) X1000 Series Processor"),
            ProcessorFamily::AMDOpteronX2000SeriesAPU                        => write!(f, "AMD Opteron(TM) X2000 Series APU"),
            ProcessorFamily::AMDOpteronASeriesProcessor                      => write!(f, "AMD Opteron(TM) A-Series Processor"),
            ProcessorFamily::AMDOpteronX3000SeriesAPU                        => write!(f, "AMD Opteron(TM) X3000 Series APU"),
            ...
            ProcessorFamily::AMDAthlon64ProcessorFamily                      => write!(f, "AMD Athlon™ 64 Processor Family"),
            ProcessorFamily::AMDOpteronProcessorFamily                       => write!(f, "AMD Opteron™ Processor Family"),
            ProcessorFamily::AMDSempronProcessorFamily                       => write!(f, "AMD Sempron™ Processor Family"),
            ProcessorFamily::AMDTurion64MobileTechnology                     => write!(f, "AMD Turion™ 64 Mobile Technology"),
            ProcessorFamily::DualCoreAMDOpteronProcessorFamily               => write!(f, "Dual-Core AMD Opteron™ Processor Family"),
            ProcessorFamily::AMDAthlon64X2DualCoreProcessorFamily            => write!(f, "AMD Athlon™ 64 X2 Dual-Core Processor Family"),
            ProcessorFamily::AMDTurion64X2MobileTechnology                   => write!(f, "AMD Turion™ 64 X2 Mobile Technology"),
            ProcessorFamily::QuadCoreAMDOpteronProcessorFamily               => write!(f, "Quad-Core AMD Opteron™ Processor Family"),
            ProcessorFamily::ThirdGenerationAMDOpteronProcessorFamily        => write!(f, "Third-Generation AMD Opteron™ Processor Family"),
            ProcessorFamily::AMDPhenomFXQuadCoreProcessorFamily              => write!(f, "AMD Phenom™ FX Quad-Core Processor Family"),
            ProcessorFamily::AMDPhenomX4QuadCoreProcessorFamily              => write!(f, "AMD Phenom™ X4 Quad-Core Processor Family"),
            ProcessorFamily::AMDPhenomX2DualCoreProcessorFamily              => write!(f, "AMD Phenom™ X2 Dual-Core Processor Family"),
            ProcessorFamily::AMDAthlonX2DualCoreProcessorFamily              => write!(f, "AMD Athlon™ X2 Dual-Core Processor Family"),
            ...
            ProcessorFamily::QuadCoreIntelXeonProcessor3200Series            => write!(f, "Quad-Core Intel® Xeon® processor 3200 Series"),
            ProcessorFamily::DualCoreIntelXeonProcessor3000Series            => write!(f, "Dual-Core Intel® Xeon® processor 3000 Series"),
            ProcessorFamily::QuadCoreIntelXeonProcessor5300Series            => write!(f, "Quad-Core Intel® Xeon® processor 5300 Series"),
            ProcessorFamily::DualCoreIntelXeonProcessor5100Series            => write!(f, "Dual-Core Intel® Xeon® processor 5100 Series"),
            ProcessorFamily::DualCoreIntelXeonProcessor5000Series            => write!(f, "Dual-Core Intel® Xeon® processor 5000 Series"),
            ProcessorFamily::DualCoreIntelXeonProcessorLV                    => write!(f, "Dual-Core Intel® Xeon® processor LV"),
            ProcessorFamily::DualCoreIntelXeonProcessorULV                   => write!(f, "Dual-Core Intel® Xeon® processor ULV"),
            ProcessorFamily::DualCoreIntelXeonProcessor7100Series            => write!(f, "Dual-Core Intel® Xeon® processor 7100 Series"),
            ProcessorFamily::QuadCoreIntelXeonProcessor5400Series            => write!(f, "Quad-Core Intel® Xeon® processor 5400 Series"),
            ProcessorFamily::QuadCoreIntelXeonProcessor                      => write!(f, "Quad-Core Intel® Xeon® processor"),
            ProcessorFamily::DualCoreIntelXeonProcessor5200Series            => write!(f, "Dual-Core Intel® Xeon® processor 5200 Series"),
            ProcessorFamily::DualCoreIntelXeonProcessor7200Series            => write!(f, "Dual-Core Intel® Xeon® processor 7200 Series"),
            ProcessorFamily::QuadCoreIntelXeonProcessor7300Series            => write!(f, "Quad-Core Intel® Xeon® processor 7300 Series"),
            ProcessorFamily::QuadCoreIntelXeonProcessor7400Series            => write!(f, "Quad-Core Intel® Xeon® processor 7400 Series"),
            ProcessorFamily::MultiCoreIntelXeonProcessor7400Series           => write!(f, "Multi-Core Intel® Xeon® processor 7400 Series"),
            ProcessorFamily::PentiumIIIXeonProcessor                         => write!(f, "Pentium® III Xeon™ processor"),
            ProcessorFamily::PentiumIIIProcessorWithIntelSpeedStepTechnology => write!(f, "Pentium® III Processor with Intel® SpeedStep™ Technology"),
            ...
            ProcessorFamily::AMDAthlonXPProcessorFamily                      => write!(f, "AMD Athlon™ XP Processor Family"),
            ProcessorFamily::AMDAthlonMPProcessorFamily                      => write!(f, "AMD Athlon™ MP Processor Family"),
            ...
            ProcessorFamily::IntelPentiumProcessorExtremeEdition             => write!(f, "Intel® Pentium® Processor Extreme Edition"),
            ...
            ProcessorFamily::IntelCore2ExtremeProcessor                      => write!(f, "Intel® Core™ 2 Extreme processor"),
            ProcessorFamily::IntelCore2QuadProcessor                         => write!(f, "Intel® Core™ 2 Quad processor"),
            ProcessorFamily::IntelCore2ExtremeMobileProcessor                => write!(f, "Intel® Core™ 2 Extreme mobile processor"),
            ProcessorFamily::IntelCore2DuoMobileProcessor                    => write!(f, "Intel® Core™ 2 Duo mobile processor"),
            ProcessorFamily::IntelCore2SoloMobileProcessor                   => write!(f, "Intel® Core™ 2 Solo mobile processor"),
            ProcessorFamily::IntelCoreI7Processor                            => write!(f, "Intel® Core™ i7 processor"),
            ProcessorFamily::DualCoreIntelCeleronProcessor                   => write!(f, "Dual-Core Intel® Celeron® processor"),
            ...
            ProcessorFamily::MultiCoreIntelXeonProcessor                     => write!(f, "Multi-Core Intel® Xeon® processor"),
            ProcessorFamily::DualCoreIntelXeonProcessor3xxxSeries            => write!(f, "Dual-Core Intel® Xeon® processor 3xxx Series"),
            ProcessorFamily::QuadCoreIntelXeonProcessor3xxxSeries            => write!(f, "Quad-Core Intel® Xeon® processor 3xxx Series"),
            ProcessorFamily::VIANanoProcessorFamily                          => write!(f, "VIA Nano™ Processor Family"),
            ProcessorFamily::DualCoreIntelXeonProcessor5xxxSeries            => write!(f, "Dual-Core Intel® Xeon® processor 5xxx Series"),
            ProcessorFamily::QuadCoreIntelXeonProcessor5xxxSeries            => write!(f, "Quad-Core Intel® Xeon® processor 5xxx Series"),
            ProcessorFamily::DualCoreIntelXeonProcessor7xxxSeries            => write!(f, "Dual-Core Intel® Xeon® processor 7xxx Series"),
            ProcessorFamily::QuadCoreIntelXeonProcessor7xxxSeries            => write!(f, "Quad-Core Intel® Xeon® processor 7xxx Series"),
            ProcessorFamily::MultiCoreIntelXeonProcessor7xxxSeries           => write!(f, "Multi-Core Intel® Xeon® processor 7xxx Series"),
            ProcessorFamily::MultiCoreIntelXeonProcessor3400Series           => write!(f, "Multi-Core Intel® Xeon® processor 3400 Series"),
            ProcessorFamily::AMDOpteron3000SeriesProcessor                   => write!(f, "AMD Opteron™ 3000 Series Processor"),
            ProcessorFamily::AMDSempronIIProcessor                           => write!(f, "AMD Sempron™ II Processor"),
            ProcessorFamily::EmbeddedAMDOpteronQuadCoreProcessorFamily       => write!(f, "Embedded AMD Opteron™ Quad-Core Processor Family"),
            ProcessorFamily::AMDPhenomTripleCoreProcessorFamily              => write!(f, "AMD Phenom™ Triple-Core Processor Family"),
            ProcessorFamily::AMDTurionUltraDualCoreMobileProcessorFamily     => write!(f, "AMD Turion™ Ultra Dual-Core Mobile Processor Family"),
            ProcessorFamily::AMDTurionDualCoreMobileProcessorFamily          => write!(f, "AMD Turion™ Dual-Core Mobile Processor Family"),
            ProcessorFamily::AMDAthlonDualCoreProcessorFamily                => write!(f, "AMD Athlon™ Dual-Core Processor Family"),
            ProcessorFamily::AMDSempronSIProcessorFamily                     => write!(f, "AMD Sempron™ SI Processor Family"),
            ProcessorFamily::AMDPhenomIIProcessorFamily                      => write!(f, "AMD Phenom™ II Processor Family"),
            ProcessorFamily::AMDAthlonIIProcessorFamily                      => write!(f, "AMD Athlon™ II Processor Family"),
            ProcessorFamily::SixCoreAMDOpteronProcessorFamily                => write!(f, "Six-Core AMD Opteron™ Processor Family"),
            ProcessorFamily::AMDSempronMProcessorFamily                      => write!(f, "AMD Sempron™ M Processor Family"),
    ...
    fn processor_family() {
        ...
        for i in 0..=0xFFFF {
            let (e, s) = match i {
                ...
                0x3D                => (AMDOpteron6200SeriesProcessor, "AMD Opteron™ 6200 Series Processor".into()),
                0x50                => (SPARCFamily, "SPARC Family".into()),
                0x65                => (Motorola68030, "68030".into()),
                0x8F                => (AMDAthlonX2DualCoreProcessorFamily, "AMD Athlon™ X2 Dual-Core Processor Family".into()),
                ...
                n @ 0xFF            => (NotUsed(n), format!("Not used. {:X}h is the un-initialized value of Flash memory.", n)),
